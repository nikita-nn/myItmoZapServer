...
--> statement-breakpoint
ALTER TABLE "premiumKeys" ADD CONSTRAINT "premiumKeys_activatedBy_users_isu_id_fk" FOREIGN KEY ("activatedBy") REFERENCES "public"."users"("isu_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

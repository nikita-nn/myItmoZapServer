...
export const switchTgNotificationsController = async (req: Request, res: Response) =>{
...
export const getMeController = async (req: Request, res: Response) => buildRes(200, req.user, res)